...
## Sprint 51 — Tag registry UI (planned — surfaces [ADR 028](adr/028-tags-as-first-class-entity.md) backend in [TagPulse-UI](https://github.com/9owlsboston/TagPulse-UI))
